		...
		if(currentStep == 0){
			...
			if(stepToDisplay.Component__c === "PRF_START"){
				...
				if(recordId){
					...
					helper.createDynamicFieldSet(component, stepToDisplay.ObjectType__c, stepToDisplay.FieldSet__c, recordId);
				}
				else{
					// Create the Dynamic Field Set dynamically with a NEW record
					helper.createDynamicFieldSet(component, stepToDisplay.ObjectType__c, stepToDisplay.FieldSet__c);
				}
