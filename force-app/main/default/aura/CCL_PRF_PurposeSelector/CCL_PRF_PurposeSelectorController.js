({
  ...
  clickNext : function(component, event, helper) {
		...
		console.log("CCL_PRF_PurposeSiteController:selectedWizardId: "+component.get("v.selectedWizardId"));
		
		// Validation
		let selectedPurposeId = component.get("v.selectedPurposeId");
		let selectedWizardId = component.get("v.selectedWizardId");
		...
		action.setParams({	selectedWizardId: selectedWizardId});
